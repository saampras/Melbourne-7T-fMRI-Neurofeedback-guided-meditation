...
#Separate slurm scripts for .11(pp44, array no. 1) 
...
echo "mv ${root_data_dir}/1.7.127/${SUB_daris}/${SUB_daris}.1/${SUB_daris}.1.${dar_d}/dicom_series/* ${root_data_dir}/bids_data_dir/sourcedata/sub${SUB_pp}_D${d}/"
mv ${root_data_dir}/1.7.127/${SUB_daris}/${SUB_daris}.1/${SUB_daris}.1.${dar_d}/dicom_series/* ${root_data_dir}/bids_data_dir/sourcedata/sub${SUB_pp}_D${d}/
